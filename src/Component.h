...
namespace Component {
	...
	public:
		Rope() {}
		Rope(size_t ropeLength, float segmentDistance, Vec2 anchor, Vec2* position) : ropeLength(ropeLength), segmentDistance(segmentDistance), anchor(anchor), position(position)
		{
